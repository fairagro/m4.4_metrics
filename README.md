...
SciWIn-Client currently has about 447 overall downloads across all versions and operating systems. The lastest version v1.2.0 currently has 37 downloads.
...
SciWIn-Client is used on all major operating systems. There are 219 downloads of the Linux executable, 99 downloads of the Windows executable and 129 downloads of the Mac OS executable.
...
The historical download chart can be viewed below. It is shown how the 447 overall downloads progressed over time by using the commited data of this repository.
