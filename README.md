...
SciWIn-Client currently has about 207 overall downloads across all versions and operating systems. The lastest version v1.0.0 currently has 20 downloads.
...
SciWIn-Client is used on all major operating systems. There are 110 downloads of the Linux executable, 40 downloads of the Windows executable and 57 downloads of the Mac OS executable.
