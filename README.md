...
SciWIn-Client currently has about 311 overall downloads across all versions and operating systems. The lastest version v1.1.0 currently has 22 downloads.
...
SciWIn-Client is used on all major operating systems. There are 163 downloads of the Linux executable, 66 downloads of the Windows executable and 82 downloads of the Mac OS executable.
...
The historical download chart can be viewed below. It is shown how the 311 overall downloads progressed over time by using the commited data of this repository.
