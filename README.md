...
SciWIn-Client currently has about 321 overall downloads across all versions and operating systems. The lastest version v1.1.0 currently has 30 downloads.
...
SciWIn-Client is used on all major operating systems. There are 171 downloads of the Linux executable, 67 downloads of the Windows executable and 83 downloads of the Mac OS executable.
...
The historical download chart can be viewed below. It is shown how the 321 overall downloads progressed over time by using the commited data of this repository.
