...
SciWIn-Client currently has about 522 overall downloads across all versions and operating systems. The lastest version v1.2.2 currently has 3 downloads.
...
SciWIn-Client is used on all major operating systems. There are 249 downloads of the Linux executable, 118 downloads of the Windows executable and 155 downloads of the Mac OS executable.
...
The historical download chart can be viewed below. It is shown how the 522 overall downloads progressed over time by using the commited data of this repository.
