...
SciWIn-Client currently has about 181 overall downloads across all versions and operating systems. The lastest version v1.0.0 currently has 17 downloads.
...
SciWIn-Client is used on all major operating systems. There are 98 downloads of the linux executable, 35 downloads of the Windows executable and 48 downloads of the Mac OS executable.
